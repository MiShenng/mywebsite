...
\resumeProject
  ...
  {Li, Zihao.*}
  {AEJMC 2026}
  {{}[\href{https://some-link.com}{\textcolor{darkblue}{\faGlobe}}]}
\resumeItemListStart
...
\resumeSubheading
  {A Study on Discourse Construction and Visual Narrative Strategies in the New Mainstream Media Environment of the Converged Media Era}{{}[\href{https://some-link.com}{\textcolor{darkblue}{\faGlobe}}]}
...
\resumePOR{China Data Journalism Competition}
    {, \textit{Second Prize (National Level)} [\href{https://github.com/your-username/repo1}{\textcolor{darkblue}{\faGithub}}]}
    {Nov. 2025}
\resumePOR{China Statistical Modeling Competition}
    {, \textit{First Prize (Provincial Level)} [\href{https://github.com/your-username/repo2}{\textcolor{darkblue}{\faGithub}}]}
    {May. 2026}
\resumePOR{Central China Mathematical Modeling Competition}
    {, \textit{Second Prize (Provincial Level)} [\href{https://github.com/your-username/repo3}{\textcolor{darkblue}{\faGithub}}]}
    {May. 2026}
