...
\quad\quad $\circ$ \textbf{GPA: \href{pdfs/en_Transcript_of_Academic_Record.pdf}{4.05/5.0}}
...
\quad\quad $\circ$ \textbf{GPA: \href{pdfs/Taiwan_records.pdf}{3.9/4.0}}
...
\end{tabularx}
\textit{PI: Zhangchi, Lanzhou University} \quad [\href{pdfs/acdamic_record1.pdf}{\faGlobe}] \hfill \textbf{Co Worker}
\begin{itemize}[nosep, leftmargin=2em, itemsep=3pt, label=$\circ$]
